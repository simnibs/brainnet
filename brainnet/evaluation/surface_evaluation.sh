...
#SBATCH --job-name=surface_eval         # Job name
...
#SBATCH --array=0-1212           # or 1,2,4,5,9 ; access as $SLURM_ARRAY_TASK_ID 5279
...
SCRIPT="${repo}/surface_evaluation.py"

cmd="python $SCRIPT topofit-ours ${SLURM_ARRAY_TASK_ID}"
