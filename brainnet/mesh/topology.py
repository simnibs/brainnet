...
def get_recursively_subdivided_topology(faces: torch.IntTensor | None = None, n_recursions: int = 0):
...
class TopologyModule(torch.nn.Module):
    ...
    def subdivide_faces(self):
        """Subdivide all faces, increasing the face count by a factor of four.2
