...
project: str = "TopoFit"
run: str = f"{mode_contrast}_{mode_resolution}_16-dec-UNET"
...
load_body_from_checkpoint = out_dir / "TopoFit-UNet" / "synth_1mm_UNet_16-dec-lessnoise" / "checkpoint" / "state_checkpoint_00250.pt"
