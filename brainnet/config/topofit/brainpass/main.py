...
project: str = "TopoFit"
run: str = f"{mode_contrast}_{mode_resolution}_BrainPass-freeze"
...
load_body_from_checkpoint = None #out_dir / "TopoFit-UNet" / "synth_random_UNet_16-dec_64" / "checkpoint" / "state_checkpoint_00200.pt"
...
topofit_kwargs = dict(
    ...
    white_channels = dict(
        encoder=[64, 96, 128, 256],
        decoder=[128, 96, 64],
    ),
    # pial_feature_maps = unet.decoder_features,
    pial_feature_maps = features,
    pial_channels = [32],
