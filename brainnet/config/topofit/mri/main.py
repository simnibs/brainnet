...
out_order = 6
target_surface = dict(resolution=out_order, name="target-decoupled")
...
cfg_results = config.ResultsParameters(
    ...
    load_from_dir = model_dir / project / resume_from_run if resume_from_run is not None else None,
)
