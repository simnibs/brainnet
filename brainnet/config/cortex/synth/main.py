...
project: str = "Cortex"
run: str = f"18_lh_{mode_contrast}_{mode_resolution}"

# run: str = f"12_lh_T1w_{mode_resolution}"

run_id: None | str = None # f"{run}-00"
resume_from_run: None | str = None #f"15_lh_{mode_contrast}_{mode_resolution}" # run
...
unet_dec_ch = [[128], [64], [32], [16]] # ! 32 32

# unet_enc_ch = [[32], [64], [64], [64], [128]]
# unet_dec_ch = [[64], [64], [64], [32]]

# unet_encoder_features = [False, False, False, False, False] # [True, True, True, True, True]
# unet_decoder_features = [True, True, True, True]
unet_encoder_features = [True, True, True, True, False] # [True, True, True, True, True]
unet_decoder_features = [True, True, True, True]
